...
public abstract class BsServiceRankBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends ServiceRank> ENTITY doSelectEntity(ServiceRankCB cb, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends ServiceRank> ENTITY doSelectEntityWithDeletedCheck(ServiceRankCB cb, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends ServiceRank> ListResultBean<ENTITY> doSelectList(ServiceRankCB cb, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends ServiceRank> PagingResultBean<ENTITY> doSelectPage(ServiceRankCB cb, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends ServiceRank> void doSelectCursor(ServiceRankCB cb, EntityRowHandler<ENTITY> handler, Class<? extends ENTITY> tp) {
