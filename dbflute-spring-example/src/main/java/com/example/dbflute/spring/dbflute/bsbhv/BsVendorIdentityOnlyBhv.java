...
public abstract class BsVendorIdentityOnlyBhv extends AbstractBehaviorWritable<VendorIdentityOnly, VendorIdentityOnlyCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends VendorIdentityOnly> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.spring.dbflute.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends VendorIdentityOnly> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
