...
public abstract class BsPmCommentHint implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.spring.dbflute.bsentity.customize.dbmeta.PmCommentHintDbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsPmCommentHint)) { return false; }
        BsPmCommentHint otherEntity = (BsPmCommentHint)other;
