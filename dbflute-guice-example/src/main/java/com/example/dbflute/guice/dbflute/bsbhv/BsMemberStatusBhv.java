...
public abstract class BsMemberStatusBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends MemberStatus> ENTITY doSelectEntity(MemberStatusCB cb, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends MemberStatus> ENTITY doSelectEntityWithDeletedCheck(MemberStatusCB cb, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends MemberStatus> ListResultBean<ENTITY> doSelectList(MemberStatusCB cb, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends MemberStatus> PagingResultBean<ENTITY> doSelectPage(MemberStatusCB cb, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends MemberStatus> void doSelectCursor(MemberStatusCB cb, EntityRowHandler<ENTITY> handler, Class<? extends ENTITY> tp) {
