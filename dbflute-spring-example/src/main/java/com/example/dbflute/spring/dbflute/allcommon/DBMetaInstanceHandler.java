...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("MEMBER_FOLLOWING", "com.example.dbflute.spring.dbflute.bsentity.dbmeta.MemberFollowingDbm");
        ...
        tmpMap.put("PURCHASE_PAYMENT", "com.example.dbflute.spring.dbflute.bsentity.dbmeta.PurchasePaymentDbm");
