...
public abstract class BsMemberLoginBhv extends AbstractBehaviorWritable {
    ...
    protected MemberLoginCB xprepareCBAsPK(Long memberLoginId) {
        ...
        MemberLoginCB cb = newConditionBean(); cb.acceptPrimaryKey(memberLoginId);
        return cb;
    }
    ...
    protected MemberLoginCB xprepareCBAsUniqueOf(Integer memberId, java.sql.Timestamp loginDatetime) {
        ...
        MemberLoginCB cb = newConditionBean(); cb.acceptUniqueOf(memberId, loginDatetime);
        return cb;
    }
    ...
    protected <RESULT> SLFunction<MemberLoginCB, RESULT> facadeScalarSelect(Class<RESULT> resultType) {
