...
public class PurchaseMaxPriceMemberDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnPurchaseMaxPrice = cci("PURCHASE_MAX_PRICE", "PURCHASE_MAX_PRICE", null, null, false, "purchaseMaxPrice", Integer.class, false, false, "INTEGER", 10, 0, null, false, null, "// max price of the member's purchases", null, null, null);
