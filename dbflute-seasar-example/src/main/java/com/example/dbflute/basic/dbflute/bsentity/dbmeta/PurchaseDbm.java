...
public class PurchaseDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPurchaseId = cci("PURCHASE_ID", "PURCHASE_ID", null, null, true, "purchaseId", Long.class, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_9540D99A_7D21_442A_87E7_B1C4D1BD7A63", false, null, null, null, null, null);
    ...
    protected final ColumnInfo _columnProductId = cci("PRODUCT_ID", "PRODUCT_ID", null, "商品ID", true, "productId", Integer.class, false, false, "INTEGER", 10, 0, null, false, null, "あなたは何を買ったのか？", "product,summaryProduct", null, null);
    ...
    protected final ColumnInfo _columnPurchaseCount = cci("PURCHASE_COUNT", "PURCHASE_COUNT", null, "購入数量", true, "purchaseCount", Integer.class, false, false, "INTEGER", 10, 0, null, false, null, "購入した商品の一回の購入における数量。", null, null, null);
    ...
    public String getConditionBeanTypeName() { return "com.example.dbflute.basic.dbflute.cbean.PurchaseCB"; }
