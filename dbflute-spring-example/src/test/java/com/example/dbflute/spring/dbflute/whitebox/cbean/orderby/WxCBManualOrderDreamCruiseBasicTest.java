package com.example.dbflute.spring.dbflute.whitebox.cbean.orderby;
...
public class WxCBManualOrderDreamCruiseBasicTest extends UnitContainerTestCase {
    ...
    public void test_DreamCruise_ManualOrder_CaseWhen_SpecifyCalculation_freedom() throws Exception {
        ...
        MemberCB cb = new MemberCB();
        MemberCB dreamCruiseCB = cb.dreamCruiseCB();
        ManualOrderBean memberIdMob = new ManualOrderBean();
        ...
        ManualOrderBean birthdateMob = new ManualOrderBean();
        birthdateMob.when_GreaterEqual(
                dreamCruiseCB.specify().columnFormalizedDatetime().convert(new ColumnConversionOption().addDay(3)))
                .or_GreaterThan(dreamCruiseCB.specify().columnUpdateDatetime());
        birthdateMob.convert(new ColumnConversionOption().addDay(4));
