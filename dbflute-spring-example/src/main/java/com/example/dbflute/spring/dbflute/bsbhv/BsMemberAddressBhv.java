...
public abstract class BsMemberAddressBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends MemberAddress> ENTITY doSelectEntity(MemberAddressCB cb, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends MemberAddress> ENTITY doSelectEntityWithDeletedCheck(MemberAddressCB cb, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends MemberAddress> ListResultBean<ENTITY> doSelectList(MemberAddressCB cb, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends MemberAddress> PagingResultBean<ENTITY> doSelectPage(MemberAddressCB cb, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends MemberAddress> void doSelectCursor(MemberAddressCB cb, EntityRowHandler<ENTITY> handler, Class<? extends ENTITY> tp) {
