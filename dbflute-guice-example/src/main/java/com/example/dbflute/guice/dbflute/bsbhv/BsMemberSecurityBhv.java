...
public abstract class BsMemberSecurityBhv extends AbstractBehaviorWritable {
    ...
    protected MemberSecurityCB xprepareCBAsPK(Integer memberId) {
        ...
        MemberSecurityCB cb = newConditionBean(); cb.acceptPrimaryKey(memberId);
        return cb;
    }
    ...
    protected <RESULT> SLFunction<MemberSecurityCB, RESULT> facadeScalarSelect(Class<RESULT> resultType) {
    ...
    public List<Member> pulloutMember(List<MemberSecurity> memberSecurityList) {
        return helpPulloutInternally(memberSecurityList, new InternalPulloutCallback<MemberSecurity, Member>() {
            ...
            { if (!ls.isEmpty()) { et.setMemberSecurityAsOne(OptionalEntity.of(ls.get(0))); } }
        });
    }
