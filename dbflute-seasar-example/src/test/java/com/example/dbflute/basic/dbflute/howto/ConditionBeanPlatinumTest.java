...
public class ConditionBeanPlatinumTest extends UnitContainerTestCase {
    ...
    //                                            ----------
    /**
     * o 空白区切りの連結曖昧検索(And条件): option.likeContain().splitBySpace(). <br />
    ...
    /**
     * o 空白区切りの連結曖昧検索(Or条件): option.likeContain().splitBySpace().asOrSplit(). <br />
     * 画面から空白区切りでキーワードを入力して検索する場合などに有効な機能。
    ...
    //                                        --------------
    /**
     * o Exists句の中でUnion: existsXxxList(), union(). <br />
    ...
    //                                      ----------------
    /**
     * o nullを最初に並べる: addOrderBy_Xxx_Asc().withNullsFirst(). <br />
    ...
    /**
     * o nullを最後に並べる: addOrderBy_Xxx_Asc().withNullsLast(). <br />
    ...
    /**
     * o nullを最後に並べる(Unionと共演): addOrderBy_Xxx_Asc().withNullsLast(), union(). <br />
    ...
    //                                          ------------
    /**
     * o 手動で並べる: addOrderBy_Xxx_Asc().withManualOrder(). <br />
    ...
    //                                                                               =====
    /**
     * o Unionのループによる不定数設定: for { cb.union() }. <br />
     */
    ...
    /**
     * o Unionを使ったページング検索: union(), selectPage(). <br />
    ...
    //                                                                            ========
    /**
     * o OnClause(On句)に条件を追加: queryXxx().on(). <br />
    ...
    //                                                                      ==============
    /**
     * o 取得カラムの指定(SpecifyColumn): specify().columnXxx(). <br />
    ...
    //                                                            ========================
    /**
     * o 子テーブル導出カラムの指定((Specify)DerivedReferrer)-Max: specify().derivedXxxList().max(). <br />
    ...
    //                                                                    ================
    /**
     * o Statementのコンフィグを設定: cb.configure(statementConfig). <br />
     */
    ...
    //                                                                        ============
    /**
     * o where句の再利用(ArrangeQuery): cb.query().arrangeXxx(). <br />
    ...
    //                                                                         ===========
    /**
     * o どんなにSubQueryやUnionの連打をしてもSQLが綺麗にフォーマット: toDisplaySql(). <br />
