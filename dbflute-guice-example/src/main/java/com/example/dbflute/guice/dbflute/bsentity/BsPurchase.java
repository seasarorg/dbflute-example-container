...
public abstract class BsPurchase extends AbstractEntity implements EntityDefinedCommonColumn {
    ...
    protected String doBuildRelationString(String dm) {
        ...
        if (_memberLoginAsBizManyToOne != null) { sb.append(dm).append("memberLoginAsBizManyToOne"); }
        if (_whiteDateTermAsValid != null) { sb.append(dm).append("whiteDateTermAsValid"); }
