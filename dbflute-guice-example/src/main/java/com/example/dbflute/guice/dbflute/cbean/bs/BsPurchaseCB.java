...
public class BsPurchaseCB extends AbstractConditionBean {
     ...
     * <pre>
     * PurchaseCB cb = new PurchaseCB();
     * cb.<span style="color: #FD4747">setupSelect_MemberLoginAsBizManyToOne()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * Purchase purchase = purchaseBhv.selectEntityWithDeletedCheck(cb);
     * ... = purchase.<span style="color: #FD4747">getMemberLoginAsBizManyToOne()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
