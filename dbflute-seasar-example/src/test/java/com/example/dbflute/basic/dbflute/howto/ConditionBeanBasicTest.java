...
public class ConditionBeanBasicTest extends UnitContainerTestCase {
    ...
    //                                                                               =====
    /**
     * o ConditionBeanを使った基本的な検索: selectList(). <br />
     * <pre>
     * 【実装手順】
    ...
    //                                                                         ===========
    /**
     * o many-to-one(FK先)を結合して取得する検索: setupSelect_Xxx(). <br />
    ...
    /**
     * o one-to-oneを結合して取得する検索: setupSelect_Xxx(). <br />
    ...
    //                                                 -----
    /**
     * o Query-Equal条件: setXxx_Equal(). <br />
     * 会員ID「3」の会員を検索。
     */
    ...
    /**
     * o 二つ以上の条件を指定: setXxx_Equal(), setXxx_Equal(). <br />
    ...
    /**
     * o 条件にnullを設定: setXxx_Equal(null). <br />
     * 会員IDにnullを設定。
     * その条件指定は無効となる。
     */
    ...
    /**
     * o 同じ条件を別の値で二回設定(Override): setXxx_Equal(3), setXxx_Equal(4). <br />
    ...
    /**
     * o 同じ条件を同じ値で二回設定(Warn): setXxx_Equal(3), setXxx_Equal(3). <br />
    ...
    /**
     * o 親テーブルの条件で絞り込み検索: queryXxx().setXxx_Equal(). <br />
    ...
    //                                               -------
    /**
     * o 昇順ソートを指定: addOrderBy_Xxx_Asc(). <br />
     * 会員アカウントの昇順で検索。
     */
    ...
    /**
     * o 降順ソートを指定: addOrderBy_Xxx_Desc(). <br />
     * 会員アカウントの降順で検索。
     */
    ...
    /**
     * o 複数条件ソートを指定: addOrderBy_Xxx_Asc().addOrderBy_Xxx_Asc(). <br />
     * 会員アカウントの昇順で検索。
     */
    ...
    /**
     * o 親テーブルのカラムでソート: queryXxx().addOrderBy_Xxx_Asc(). <br />
     * 関連する会員退会情報の退会理由コードが'PRD'の会員を検索。
     */
