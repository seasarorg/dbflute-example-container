...
public abstract class AbstractBsMemberWithdrawalCQ extends AbstractConditionQuery {
    ...
    public void inScopeMember(SubQuery<MemberCB> subQuery) {
        ...
        try { lock(); subQuery.query(cb); } finally { unlock(); } String pp = keepMemberId_InScopeRelation_Member(cb.query());
    ...
    public void notInScopeMember(SubQuery<MemberCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        MemberCB cb = new MemberCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); } String pp = keepMemberId_NotInScopeRelation_Member(cb.query());
    ...
    public void inScopeWithdrawalReason(SubQuery<WithdrawalReasonCB> subQuery) {
        ...
        try { lock(); subQuery.query(cb); } finally { unlock(); } String pp = keepWithdrawalReasonCode_InScopeRelation_WithdrawalReason(cb.query());
    ...
    public void notInScopeWithdrawalReason(SubQuery<WithdrawalReasonCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        WithdrawalReasonCB cb = new WithdrawalReasonCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); } String pp = keepWithdrawalReasonCode_NotInScopeRelation_WithdrawalReason(cb.query());
